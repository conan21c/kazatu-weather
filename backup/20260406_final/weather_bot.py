...
def generate_ai_comment(weather_data):
    ...
    try:
        ...
        # Keep newlines so we can split it into a list in the render function
...
def render_html_to_image(weather_data, ai_comment):
    ...
    # Split the AI comment string into a list for the bulleted list in our template
    ...
    html_content = template.render(
        ...
        ai_advice_list=ai_advice_list, # Updated to match template variable name
        day_eng=day_eng,
        date_str=date_str
    )
